<?php
    ...
    */
    ...
    require_once "./Modelos/Verificacion.model.php";
                   ...
                   echo '<script>
                           ...
                           Swal.fire({
                             ...
                             confirmButtonText: "Aceptar"
                                         ...
                                         if (result.value) {
                                             /**Redireccionar a la página principal de verificacion */
                                             window.location.href = "index.php?ruta=Verificacion/verificacion";
                                         }
                                     })
                         </script>';
